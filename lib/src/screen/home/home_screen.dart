            ...
            itemBuilder: (context, index) {
              return Padding(
                ...
                child: InkWell(
                  ...
                  child: SizedBox(
                    width: isMobile(context) ? 125.w : 80.w,
                    child: CachedNetworkImage(
                      imageUrl: homeScreenContentController.homeDataModel.value
                          .data![brandIndex].popularBrands![index].thumbnail!,
                      fit: BoxFit.contain,
                    ),
                  ),
                ),
                                  ...
                                  children: [
                                    Text(
                                      homeScreenContentController
                                          ...
                                          .title!,
                                      style: isMobile(context)
                                          ? AppThemeData.titleTextStyle_16
