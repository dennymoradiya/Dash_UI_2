          ...
          userDataModel.data!.email == "" && userDataModel.data!.phone == ""
              ...
              : Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: AppThemeData.headlineTextColor.withOpacity(0.05),
        ...
        child: Column(
          children: [
            ...
            _profileContentController
                        .profileDataModel.value.data!.isOrderedDigitalProduct !=
                    false
                ? Container(
                    decoration: BoxDecoration(
                      color: AppThemeData.headlineTextColor.withOpacity(0.05),
                    ...
                    child: Padding(
                      ...
                      child: InkWell(
                          ...
                          child: mobileViewTile(
                              "download", AppTags.myDownload.tr)),
                    ),
                  )
                : const SizedBox(),
            SizedBox(
                  ...
                  ? Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                            ...
                            child:
                                mobileViewTile("reward", AppTags.myRewards.tr)),
                      ))
                  : const SizedBox(),
            ...
            Container(
              ...
              child: Padding(
                ...
                child: InkWell(
                    ...
                    child: mobileViewTile(
                        "notification", AppTags.notification.tr)),
              ),
            ),
            SizedBox(
              height: 9.h,
            ...
            Container(
              ...
              child: Padding(
                ...
                child: InkWell(
                    ...
                    child:
                        mobileViewTile("track_order", AppTags.trackOrder.tr)),
              ),
            ),
            SizedBox(
              height: 9.h,
            ...
            Container(
              ...
              child: Padding(
                ...
                child: InkWell(
                    ...
                    child: mobileViewTile(
                        "order_history", AppTags.orderHistory.tr)),
              ),
            ),
            SizedBox(
              height: 9.h,
